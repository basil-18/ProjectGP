...
public class BaseCls {
	public static WebDriver pro;
	public static void pageUrl() {
		String url = pro.getCurrentUrl();
		...
		pro=new ChromeDriver();
	}public static void lanuchUrl(String url) {
		pro.get(url);
	}public static void maxWindow() {
		pro.manage().window().maximize();
	}public static void waits() {
		pro.manage().timeouts().implicitlyWait(Duration.ofSeconds(10));
	...
	public static void takeS(String loc) throws IOException {
		TakesScreenshot tk=(TakesScreenshot)pro;
